...
public class Combustivel {
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null, "Seja bem vindo ao sistema de cálculo com gastos em combustível.");
        ...
        String preço = JOptionPane.showInputDialog("Por fim, qual o valor do preço do Litro do combustível? (Use ponto ao invés de vírgula)");
